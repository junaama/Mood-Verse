      ...
      <span style={{ color: "rgb(127, 127, 127)" }}>
        <strong>
          <span data-custom-class="subtitle">
            Last updated <bdt className="question">August 18, 2020</bdt>
          </span>
        </strong>
      </span>
    </p>
    ...
    <p style={{ fontSize: 15 }}>
      <span style={{ color: "rgb(89, 89, 89)" }}>
        <span data-custom-class="body_text">
          ...
          <bdt className="question">Mood Verse</bdt>
          ...
          <bdt className="question">0naama0@gmail.com</bdt>.
        </span>
      </span>
    </p>
    <p style={{ fontSize: 15 }}>
      <span style={{ color: "rgb(89, 89, 89)" }}>
        ...
        <span data-custom-class="body_text">
          ...
          notice<span style={{ color: "rgb(89, 89, 89)" }}>&nbsp;</span>that you
      ...
      <span style={{ color: "rgb(89, 89, 89)" }}>
        <strong>
          <span data-custom-class="body_text">
            ...
            <span style={{ color: "rgb(89, 89, 89)" }}>&nbsp;</span>carefully as
            it will help you understand what we do with the information that we
            collect.
          </span>
        </strong>
      </span>
    ...
    <p style={{ fontSize: 15 }}>
      <span data-custom-class="body_text">
        <span style={{ fontSize: 15 }}>
          ...
          <bdt className="block-component" /> or otherwise when you contact us.
        </span>
      </span>
    </p>
    <p style={{ fontSize: 15 }}>
      ...
      <ul>
              ...
              <span style={{ fontSize: 15 }}>
                <span style={{ color: "rgb(89, 89, 89)" }}>
                  ...
                  <span data-custom-class="body_text">
                    ...
                    from those third parties to facilitate account creation and
        ...
        <li>
          <span style={{ fontSize: 15 }}>
            <span style={{ color: "rgb(89, 89, 89)" }}>
              <strong>
                <span data-custom-class="body_text">To post testimonials.</span>
              </strong>
              <span data-custom-class="body_text">
                ...
                the consent of the testimonial. If you wish to update, or delete
                ...
                <div>
                    ...
                    <span style={{ fontSize: 15 }}>
                      <span style={{ color: "rgb(89, 89, 89)" }}>
                        <span data-custom-class="body_text">
                          ...
                          and (iv) if applicable, to data portability. In
                    ...
                    <span style={{ fontSize: 15 }}>
                      <span style={{ color: "rgb(89, 89, 89)" }}>
                        <span data-custom-class="body_text">
                          ...
                          before its withdrawal, nor will it affect the
                    ...
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      <span style={{ fontSize: 15 }}>
                        ...
                        <span data-custom-class="body_text">
                          ...
                          details provided below. You will then be removed from
                          the marketing email list – however, we may still
                  ...
                  <p style={{ fontSize: 15 }}>
                    <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        ...
                        and have a registered account with{" "}
                        <span
                          style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}
                        >
                          <span data-custom-class="body_text">
                  ...
                  <p style={{ fontSize: 15 }}>
                    <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        ...
                        of these categories in instances where you interact with
                  ...
                  <div>
                    <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        ...
                        right to opt-out, we may deny a request if the
                        authorized agent does not submit proof that they have
                    ...
                    <span style={{ color: "rgb(0, 0, 0)" }}>
                      <span style={{ fontSize: 15 }}>
                        <span data-custom-class="body_text">
                          ...
                          provide information so that we can match it with the
                  ...
                  <p style={{ fontSize: 15 }}>
                    <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        ...
                        from time to time. The updated version will be indicated
                  ...
                  <p style={{ fontSize: 15 }}>
                    <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        ...
                        may <bdt className="block-component" />
                        email us at{" "}
                        <bdt className="question">0naama0@gmail.com</bdt>
                        <bdt className="statement-end-if-in-editor" /> or by
                        post to:
                      </span>
                    </span>
                  </p>
                  <div>
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      <bdt className="question">
                        <span style={{ fontSize: 15 }}>
                          <span data-custom-class="body_text">Mood Verse</span>
                        </span>
                        &nbsp;
                      </bdt>
                      <span data-custom-class="body_text">
                  ...
                  <div>
                    <span data-custom-class="body_text">
                      ...
                      <bdt className="block-component" />
                      visit: <bdt className="question">__________</bdt>
